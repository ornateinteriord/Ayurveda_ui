...
import { Typography, Box, Grid, Card, CardContent, CardMedia, Button, IconButton, Dialog, DialogTitle, DialogActions, DialogContent } from '@mui/material';
import AddIcon from '@mui/icons-material/Add';
import RemoveIcon from '@mui/icons-material/Remove';
import oils from '../../assets/images/oils1.avif'; // Ensure the image path is correct
import './Oils.css'; // External CSS file
...
const Oils = () => {
  ...
  const products = Array(8).fill({
    name: 'Oils Product',
    description: 'This is an oils product description.',
    price: '$10',
    image: oils,
  });

  return (
    <Box className="oils-container">
      <Typography variant="h4" gutterBottom className="oils-title">
        Oils
      </Typography>
      <Grid container spacing={1} className='product-card-grid'>
