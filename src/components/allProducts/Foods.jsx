...
import foods from '../../assets/images/foods.avif'; // Ensure the image path is correct
import './Foods.css'; // External CSS file
...
const Foods = () => {
  ...
  const products = Array(8).fill({
    name: 'Foods Product',
    description: 'This is a food product description.',
    price: '$10',
    image: foods,
  });

  return (
    <Box className="foods-container">
      <Typography variant="h4" gutterBottom className="foods-title">
        Foods
      </Typography>
      <Grid container >
      ...
      {selectedProduct && (
        <Dialog open={open} onClose={handleClose}>
          ...
          <DialogActions className="dialog-actions">
            ...
            <Button variant="contained" sx={{ background: '#34495e' }}>Buy Now</Button>
          </DialogActions>
        </Dialog>
      )}
    </Box>
