...
import health from '../../assets/images/health1.avif'; // Ensure the image path is correct
import './HealthCare.css'; // External CSS file
...
const Healthcare = () => {
  ...
  const products = Array(8).fill({
    ...
    description: 'This is a health care product description.',
    price: '$10',
    image: health,
  });
  ...
  return (
    <Box className="health-container">
      <Typography variant="h4" gutterBottom className="health-title">
        Health Care
      </Typography>
      <Grid container >
